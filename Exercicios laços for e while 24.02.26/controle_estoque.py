...
# é verificar a quantidade de exemplares de um livro em estoque e continuar vendendo até que 
# o estoque se esgote. Sempre que uma venda é realizada, o sistema deve informar o usuário e 
